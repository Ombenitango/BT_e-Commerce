...
<div class="flex flex-col items-center p-2 relative">
    <button on:click={()=>{resize()}} type="button" data-dropdown-toggle="language-dropdown-menu" class="w-full inline-flex items-center justify-start p-4 text-sm text-neutral-500 rounded cursor-pointer hover:text-neutral-900 hover:bg-neutral-100 dark:hover:bg-neutral-700 dark:hover:text-white">
    ...
    <!-- Dropdown -->
    <div bind:this={collapse} class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-neutral-100 rounded shadow dark:bg-neutral-700 absolute bottom-[30%]" id="language-dropdown-menu">
